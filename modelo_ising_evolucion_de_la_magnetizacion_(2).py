# -*- coding: utf-8 -*-
"""Modelo Ising Evolucion de la Magnetizacion (2)

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-ummKbM4YGd3QStpGaqx1M8E3MUoc63Q
...
plt.scatter(T, E, color='IndianRed')
plt.xlabel("Temperature (T)", fontsize=20);
plt.ylabel("Energy ", fontsize=20);         plt.axis('tight');

sp =  f.add_subplot(2, 2, 2 );
plt.scatter(T, abs(M), color='RoyalBlue')
plt.xlabel("Temperature (T)", fontsize=20); 
plt.ylabel("Magnetization ", fontsize=20);   plt.axis('tight');

sp =  f.add_subplot(2, 2, 3 );
plt.scatter(T, C, color='IndianRed')
plt.xlabel("Temperature (T)", fontsize=20);  
plt.ylabel("Specific Heat ", fontsize=20);   plt.axis('tight');   

sp =  f.add_subplot(2, 2, 4 );
plt.scatter(T, X, color='RoyalBlue')
plt.xlabel("Temperature (T)", fontsize=20); 
...
class Ising():
    ...
    def simulate(self):   
        ...
        N, temp     = 50, 6        # Initialse the lattice
